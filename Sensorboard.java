...
/**
 * Java-Class to access the sensorboard from an EV3 with leJOS.
...
public class Sensorboard extends Thread {
     ...
     */
    public Sensorboard(Port port) {
        this.port = (I2CPort) port.open(I2CPort.class);
        this.port.setType(I2CPort.TYPE_LOWSPEED);
     ...
     * @param cycles Sensor Timing, less cycles means higher sample rate
     */
    public Sensorboard(Port port, int brightness, int gain, int cycles) {
    	this(port);
